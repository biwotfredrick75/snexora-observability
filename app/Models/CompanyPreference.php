...
class CompanyPreference extends Model
{
    ...
    protected $fillable = [
        ...
        'company_number', 'kra_pin',
        'etims_bhf_id', 'etims_dvc_srl_no', 'etims_env', 'etims_api_key', 'etims_gateway_url',
        'currency', 'debtors_gl_code', 'discount_gl_code', 'logo_filename',
        ...
        'po_requires_hod_approval', 'po_requires_finance_approval', 'po_requires_ceo_approval',
        'pr_requires_hod_approval', 'pr_requires_finance_approval', 'pr_requires_ceo_approval',
        'base_price_calc', 'add_price_from_std_cost', 'auto_standard_cost', 'round_prices',
    ...
    protected function casts(): array
    {
        return [
            ...
            'po_requires_hod_approval'        => 'boolean',
            'po_requires_finance_approval'    => 'boolean',
            'po_requires_ceo_approval'        => 'boolean',
            'pr_requires_hod_approval'        => 'boolean',
            'pr_requires_finance_approval'    => 'boolean',
            'pr_requires_ceo_approval'        => 'boolean',
            'auto_standard_cost'    => 'boolean',
